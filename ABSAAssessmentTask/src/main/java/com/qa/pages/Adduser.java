...
public void sendkeys() {
	...
	lastname.clear();
	lastname.sendKeys("duggirala");
}

// sending the unique username
	public void uniquename() {
		username.clear();
		username.sendKeys("umasamyuktha");
	...
	public void uniqueusername() {
		username.clear();
		username.sendKeys("samyutktha");
	}
	//sending the password 
	public void Password() {
	password.clear();
	password.sendKeys("uma1234");
	}
	...
	public void emailmethod() {
		// enter the email id
	email.clear();
	email.sendKeys("uma27.d@gmail.com");
	
	// enter the cellphone number
	cell.clear();
	cell.sendKeys("0123456789");
